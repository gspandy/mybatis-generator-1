...
public class Interface extends JavaElement implements CompilationUnit {
    ...
    public String getFormattedContent() {
        ...
        sb.append(" * 　　┃　　　　　　　┃\n");
        sb.append(" * 　　┗━┓　　　┏━┛\n");
        sb.append(" * 　　　　┃　　　┃神兽保佑, 永无BUG!\n");
        sb.append(" * 　　　　┃　　　┃Code is far away from bug with the animal protecting\n");
        sb.append(" * 　　　　┃　　　┗━━━┓\n");
        sb.append(" * 　　　　┃　　　　　　　┣┓\n");
        sb.append(" * 　　　　┃　　　　　　　┏┛\n");
        sb.append(" * 　　　　┗┓┓┏━┳┓┏┛\n");
        ...
        sb.append(" */");
        newLine(sb);
        sb.append("@SuppressWarnings(\"UnnecessaryInterfaceModifier\")");
        newLine(sb);
        ...
        while (mtdIter.hasNext()) {
            ...
            sb.append(method.getFormattedContent(indentLevel, false, false));
            if (mtdIter.hasNext()) {
                newLine(sb);
            }
        }
