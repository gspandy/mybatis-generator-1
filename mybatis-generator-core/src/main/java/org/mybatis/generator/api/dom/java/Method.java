...
public class Method extends JavaElement {
    ...
    public String getFormattedContent(int indentLevel, boolean interfaceMethod) {
        return getFormattedContent(indentLevel, interfaceMethod, true);
    }

    public String getFormattedContent(int indentLevel, boolean interfaceMethod, boolean checkAbstract) {
