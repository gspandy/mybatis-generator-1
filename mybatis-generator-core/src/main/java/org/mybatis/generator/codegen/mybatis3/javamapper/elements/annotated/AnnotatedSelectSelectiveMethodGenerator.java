...
import org.mybatis.generator.codegen.StyleConstant;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectSelectiveMethodGenerator;
 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectSelectiveMethodGenerator extends
    SelectSelectiveMethodGenerator {

    private boolean useResultMapIfAvailable;

    public AnnotatedSelectSelectiveMethodGenerator(boolean useResultMapIfAvailable) {
        super();
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        while (iter.hasNext()) {
            ...
            if (sb.length() > StyleConstant.CODE_LINE) {
                sb.append("\","); //$NON-NLS-1$
                method.addAnnotation(sb.toString());
